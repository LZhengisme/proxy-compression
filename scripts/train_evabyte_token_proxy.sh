#!/bin/bash
# =============================================================================
# Train EvaByte with Proxy Compression (token)
# =============================================================================
...
EXP_NAME=evabyte_token_proxy_90tokens10bytes_multisymbolpredc1r1
torchrun --nproc-per-node $NUM_GPUS -m apps.evabyte.train \
  config=apps/evabyte/configs/evabyte_1b5.yaml \
  data.tokenizer.name=token_plus_byte \
  data.tokenizer.spm_byte_path=infly/OpenCoder-1.5B-Base \
