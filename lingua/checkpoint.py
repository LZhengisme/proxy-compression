...
from lingua.checkpoint_utils import DistCPDefaultLoadPlanner
...
def load_from_checkpoint(ckpt_dir: str, model: nn.Module, optimizer: Optional[torch.optim.Optimizer] = None, model_key: str = "model", optim_key: str = "optim"):
    ...
    dcp.load(state_dict, checkpoint_id=ckpt_dir, planner=DistCPDefaultLoadPlanner())
    set_model_state_dict(
        model,
...
class CheckpointManager:
    ...
    def load(
        ...
        dcp.load(state_dict, checkpoint_id=path, planner=DistCPDefaultLoadPlanner())
